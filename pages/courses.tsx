...
import { coursesApi, getCourses, useGetCoursesQuery } from "../services/coursesApi";
...
export const getServerSideProps = wrapper.getServerSideProps(
  (store) => async (context) => {
    store.dispatch(getCourses.initiate(""));
    await Promise.all(store.dispatch(coursesApi.util.getRunningQueriesThunk()));
    return {
      props: {},
    };
  }
